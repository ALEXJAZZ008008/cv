...
\begin{document}
    \begin{rSection}{Experience}
        \item \begin{rSubsection}{London South Bank University}{2025 - Present}{Visiting Fellow}{}
            \item I am currently working at London South Bank University from the winter of 2025 as a visiting fellow. Here I am the lead of a project to develop a neural network based method to extract a metabolite corrected arterial input signal from dynamic PET. I'm also involved in the selection and mentoring of PhD students.
        \end{rSubsection}
